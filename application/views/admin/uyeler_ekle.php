                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="<?=base_url()?>admin/uyeler/ekle_kaydet">
                                 ...
                                 <div class="form-group">
										...
										<div class="form-group">
                                            <label>Telefon</label>
                                            <input class="form-control" name="tel" type="phone">
										...
										<div class="form-group">
                                            <label> Şehir</label>
   											<select class="form-control" name="sehir" type="text">
                                        ...
                                        <button type="reset" class="btn btn-warning">FORMU SIFIRLA</button>
