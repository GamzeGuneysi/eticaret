...
<head>
    ...
    <link href="<?=base_url()?>assets/admin/css/font-awesome.css" rel="stylesheet" />
     <!-- PAGE LEVEL STYLES-->
    <link href="<?=base_url()?>assets/admin/css/error.css" rel="stylesheet" />
    <!-- GOOGLE FONTS-->
    ...
    <div class="container">
         ...
         <div class="row text-center">
                ...
                <div class="col-md-12 set-pad" >
                           ...
                           <p class="p-err">Üzgünüm sayfa bulunamadı.</p>
        </div>
    </div>
    <div class="container">
        <div class="row text-center">
            <div class="col-md-12">
                  <br />
    <br />
               <a class="btn btn-success" href="<?=base_url()?>admin">
                        PLEASE GO BACK TO WEBSITE !
                    </a>
                  <br />
    <br />
            </div>
