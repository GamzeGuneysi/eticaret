...
<body style="background-color: #E2E2E2;">
    <div class="container">
        <div class="row text-center " style="padding-top:100px;">
            <div class="col-md-12">
                <h1 style="font-weight: bold;">Login Formu</h1>
            </div>
        </div>
         <div class="row ">
					...
					<?php } ?>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <span class="pull-right">
                                                   <a href="<?=base_url()?>home/login/sifre_unuttum" >Şifremi unuttum? </a> 
                                            </span>
                                        </div>
                                     
                                     <input type="submit" class="btn btn-primary" value="Şimdi Gir"/>
                                            <span class="pull-right">
                                                   <a class="btn btn-warning" href="<?=base_url()?>home/kayit_ol" >KAYIT OL </a> 
                                            </span>
                                    <hr />
                                    </form>
                            </div>
